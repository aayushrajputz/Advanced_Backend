...
export interface MatchingStrategy {
    match(newOrder: any): Promise<any>
}

export class PriceTimePriorityMatching implements MatchingStrategy {
    async match(newOrder: any): Promise<any> {
...
export const matchOrder = async (newOrder: any) => {
    const strategy: MatchingStrategy = new PriceTimePriorityMatching();
    return await strategy.match(newOrder);
};
